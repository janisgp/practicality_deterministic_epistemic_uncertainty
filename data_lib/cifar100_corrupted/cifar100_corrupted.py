...
TODO(postels): Finish tf2 PR -> https://github.com/tensorflow/datasets/pull/2152
"""
...
class Cifar100Corrupted(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self):
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            "label": tfds.features.ClassLabel(num_classes=_CIFAR_100_CLASSES),
        }),
  ...
  def _split_generators(self, dl_manager):
    ...
    return [
        tfds.core.SplitGenerator(
            ...
            gen_kwargs={
                "data_dir": os.path.join(path, self._cifar_info.prefix)
            },
        )
    ]
